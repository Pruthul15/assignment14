...
from sqlalchemy import Column, String, Boolean, DateTime, or_, UniqueConstraint
...
class User(Base):
    ...
    def register(cls, db, user_data: dict):
        ...
        # Manual pre-check for user-friendly fast error, but final guard is db.flush()
        ...
        db.add(user)
        db.flush()  # This will enforce all DB-level constraints immediately
        return user
